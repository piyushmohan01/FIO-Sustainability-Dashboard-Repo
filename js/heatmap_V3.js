...
function createHeatmap(weeklyData, { width = 960, onStats = null } = {}) {
  ...
  const EVENTS_BY_GROUP = {
    public_holidays: [
      { date: "2023-01-02", label: "New Year's Day BH" },
      { date: "2023-04-07", label: "Good Friday BH"    },
      { date: "2023-04-10", label: "Easter Monday BH"  },
      { date: "2023-05-01", label: "Early May BH"      },
      { date: "2023-05-29", label: "Spring BH"         },
      { date: "2023-08-28", label: "Summer BH"         },
      { date: "2023-12-25", label: "Christmas Day BH"  },
      { date: "2023-12-26", label: "Boxing Day BH"     },
    ],
    cultural_events: [
      { date: "2023-03-19", label: "Mother's Day"      },
      { date: "2023-03-23", label: "Ramadan Start"     },
      { date: "2023-04-07", label: "Good Friday"       },
      { date: "2023-04-10", label: "Easter Monday"     },
      { date: "2023-04-21", label: "Ramadan End"       },
      { date: "2023-06-18", label: "Father's Day"      },
      { date: "2023-10-31", label: "Halloween"         },
      { date: "2023-11-12", label: "Diwali"            },
      { date: "2023-12-25", label: "Christmas"         },
    ],
    school_calendar: [
      { date: "2023-02-13", label: "SH-1 S"            },
      { date: "2023-02-17", label: "SH-1 E"            },
      { date: "2023-04-03", label: "SH-2 S"            },
      { date: "2023-04-14", label: "SH-2 E"            },
      { date: "2023-05-29", label: "SH-3 S"            },
      { date: "2023-06-02", label: "SH-3 E"            },
      { date: "2023-07-25", label: "SH-4 S"            },
      { date: "2023-09-04", label: "SH-4 E"            },
      { date: "2023-10-23", label: "SH-5 S"            },
      { date: "2023-10-27", label: "SH-5 E"            },
      { date: "2023-12-20", label: "SH-6 S"            },
      { date: "2023-12-31", label: "SH-6 E"            },
    ],
    weather_events: [
      { date: "2023-06-10", label: "HW (3 days)"       },
      { date: "2023-07-17", label: "HW (4 days)"       },
      { date: "2023-08-10", label: "HW (5 days)"       },
    ],
    sporting_events: [
      { date: "2023-02-04", label: "SN S"              },
      { date: "2023-03-18", label: "SN E"              },
      { date: "2023-07-20", label: "WE S"              },
      { date: "2023-08-03", label: "WE E"              },
      { date: "2023-07-28", label: "WC S"              },
      { date: "2023-08-08", label: "WC E"              },
    ],
  };
